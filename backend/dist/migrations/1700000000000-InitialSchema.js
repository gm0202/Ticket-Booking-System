...
class InitialSchema1700000000000 {
    ...
    `);
        ...
        // Create admin user
        await queryRunner.query(`INSERT INTO users (email, name, password, role) VALUES ($1, $2, $3, $4) ON CONFLICT (email) DO NOTHING`, ['admin@example.com', 'Admin User', '$2a$10$Xl0yhvzLIaJCDdKBS0Lld.ksK7c2Zytg/ZKFdtIYYQUv8rUfvCR4W', 'admin']);
    }
